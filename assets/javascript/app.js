 // Initialize Firebase
  var config = {
    apiKey: "AIzaSyDwZxkBTZIBoq-Krpze9S-EM9hujnFLF-Y",
    authDomain: "train-scheduler-a3672.firebaseapp.com",
    databaseURL: "https://train-scheduler-a3672.firebaseio.com",
    storageBucket: "trains",
    messagingSenderId: "653388524969"
  };
	...
	//Create Firebase event for adding trains to the database and a row in the html with entries
		...
		//Add stored trains to the schedule
			...
			//Push first time back a year to make sure it comes before current time
				...
				// $('#deleteRow').append('<button id=\"deleteTrain\" type=\"submit\" class=\"btn btn-primary\" onclick=\"deleteTrain(\''+train.Name+'\');\">Delete</button>');
				$('#deleteRow').append("<br/>");
